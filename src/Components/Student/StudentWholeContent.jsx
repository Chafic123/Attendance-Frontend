...
export default function StudentWholeContent({ isNotificationStatusChanged,setIsNotificationStatusChanged,setSelectedText, selectedDashboardITem, viewProfile, viewPanel, viewPanelIphone,refreshProfile }) {
  return (
    <div className="whole-content-container">
      <StudentMainContent isNotificationStatusChanged={isNotificationStatusChanged} setIsNotificationStatusChanged={setIsNotificationStatusChanged}  viewPanelIphone = {viewPanelIphone} viewProfile={viewProfile} selectedDashboardITem={selectedDashboardITem} />
